...
function my_touchmove(e){
    ...
    console.assertlog("Last position of x and y coordinates = ");
    console.log("x = " + last_position_x + ",y = " + last_position_y);
    ctx.moveTo(last_position_x, _last_position_y);

    console.log("Current position of x and y coordinates = ");
    console.log("x  = " + current_position_of_mouse_x, current_position_of_mouse_y);
    ctx.lineTo(urrent_position_of_mouse_x, current_position_of_mouse_y);
    ctx.stroke();
